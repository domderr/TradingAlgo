...
def archive_existing_pipeline_outputs():
    ...
    candidates = [
        ...
        output_dir / "all_market_reports_data.json",
        output_dir / "all_market_reports_data.csv",
        output_dir / "all_market_reports_data.pre_conservative_haircut.json",
        output_dir / "all_market_reports_data.pre_conservative_haircut.csv",
    ]
    candidate_dirs = [
...
try:
    ...
    if market_reports_df is not None and not market_reports_df.empty:
        ...
        market_reports_df.to_csv(output_dir / "all_market_reports_data.pre_conservative_haircut.csv", index=False)
